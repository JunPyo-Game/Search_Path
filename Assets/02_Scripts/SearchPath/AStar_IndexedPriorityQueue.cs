...
// IndexedPriorityQueue 기반의 A* 경로 탐색 알고리즘 구현
// - 인덱스 기반 우선순위 큐로 빠른 갱신/삽입/삭제 지원
// - ClosedSet 없이 큐만으로 중복 방문 제어
public class AStar_IndexedPriorityQueueOnly : PathSearch
{
    ...
    // 인덱스 기반 우선순위 큐 (g+h가 최소인 노드를 먼저 꺼냄)
